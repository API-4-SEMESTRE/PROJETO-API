...
import com.api.name.domain.fornecedor.Fornece;
import com.api.name.domain.fornecedor.ForneceService;
import com.api.name.domain.fornecedor.Fornecedor;
import com.api.name.domain.fornecedor.FornecedorService;
