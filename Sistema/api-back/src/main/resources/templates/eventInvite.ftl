...
<body>
    <div style="text-align: center">
        ...
        <h3>Olá, você foi convidado para um evento!</h3>
    </div>

    <div class="center-justify" style="text-align: justify; position: relative; width: 400px; margin: 0 auto">
        Você recebeu este email porque foi convidado para participar um evento pela AgendHouse. Segue as informações dele:<br><br>
        Por: ${criador};<br>
